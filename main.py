...
VIDEOS = {'Digimon': [{'name': 'Season 1 Episode 1',
            ...
            'The Day My Bum Went Psycho': [{'name': 'Episode 1',
                      'thumb': 'http://www.net-games.co.il/media/img/video_thumbs/KrAdcqEn.jpg',
                      'video': 'http://mediadownload.ynet.co.il/netgames/net-games/zoom/tusik/tusik1.mp4',
                      'genre': 'Animation'},
                     {'name': 'Episode 2',
                      'thumb': 'http://www.net-games.co.il/media/img/video_thumbs/JINDcjdd.jpg',
                      'video': 'http://mediadownload.ynet.co.il/netgames/net-games/zoom/tusik/tusik2.mp4',
                      'genre': 'Animation'},
                     {'name': 'Episode 3',
                      'thumb': 'http://www.net-games.co.il/media/img/video_thumbs/eohgFAnD.jpg',
                      'video': 'http://mediadownload.ynet.co.il/netgames/net-games/zoom/tusik/tusik3.mp4',
                      'genre': 'Animation'},
                     {'name': 'Episode 4',
